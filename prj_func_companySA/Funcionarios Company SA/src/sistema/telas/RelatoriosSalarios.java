...
public class RelatoriosSalarios extends JPanel 
{
    ...
    private void criarComponentes()
    {
        ...
        // 1- Instanciando os componentes da tela
        
        labelTitulo = new JLabel("Relatórios", JLabel.CENTER);
        labelTitulo.setFont(new Font(labelTitulo.getFont().getName(), Font.PLAIN, 20));
        labelDescricao = new JLabel("Esse gráfico representa a quantidade de funcionarios por faixas de salario", JLabel.CENTER);
        
        // 1.1 - construindo o gráfico
        
        CategoryDataset dadosGrafico = this.criarDadosGrafico();
        
        JFreeChart someChart = ChartFactory.createBarChart3D("", null, "Quantidade de Funcionarios", dadosGrafico, PlotOrientation.VERTICAL, true, true, false);
       ...
       try
       {
          // Conectando ao banco de dados
           ...
           while(resultados.next())
           {
               ...
               dados.addValue(resultados.getInt("faixa5"), "De R$ 4.000,00 até R$ 5.000,00", "R$ 4.000,00 - R$ 5.000,0");
               dados.addValue(resultados.getInt("faixa6"), "A parti de R$ 5.000,00", "> R$ 5.000,00");
